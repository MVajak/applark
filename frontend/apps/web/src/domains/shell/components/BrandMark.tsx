  ...
  return (
    <span className={cn('inline-flex items-center gap-2', className)}>
      ...
      {(variant === 'wordmark' || variant === 'full') && (
        <span className="text-title-small-bold tracking-tight">PostPilot</span>
      )}
    </span>
  );
}
...
function BrandIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-6" aria-hidden role="img">
      ...
      <defs>
        <linearGradient id="postpilot-brand" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path d="M12 2 L20 12 L12 22 L4 12 Z" fill="url(#postpilot-brand)" opacity="0.9" />
